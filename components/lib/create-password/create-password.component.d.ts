...
export declare class CreatePasswordComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CreatePasswordComponent, "cdk-create-password", never, { "messageValidation": "messageValidation"; }, { "passwordValidation": "passwordValidation"; "submitEvent": "submitEvent"; "passwordEvent": "passwordEvent"; }, never, never, false, never>;
}
